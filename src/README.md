...
4.[FontLicense(NanumGothicBold)](#FontLicense(NanumGothicBold))
...
1. CLI
    ...
    There is an argument for the user.
        ...
        python meme.py -p -b -a

    or

        python meme.py --path --body --author

    -p and --path argument put the image path you need for meme picture here.

    no argument, use Random picture.

    -b and --body argument is write your content.
...
## FontLicense(NanumGothicBold)

The font "Sharing Gothic" used in the meme generator is licensed as follows.
